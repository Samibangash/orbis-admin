    ...
    <div class="modal fade" id="addItemModel" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <!--begin::Form-->
                <form id="kt_modal_add" class="form" method="POST" enctype="multipart/form-data" action="{{ route('bank.store') }}">
                    @csrf
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function(data, type, full, meta) {
                                if(data !== null) {
                                    return '<img class="max-w-40px" src="{{ asset('/storage/images/bank_logo') }}/'+ data +'">';
                                } else {
