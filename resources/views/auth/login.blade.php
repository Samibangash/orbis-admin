					...
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							<div class="mb-20">
								...
								<p class="opacity-60 font-weight-bold">Enter your details to login in your account:</p>
							</div>
							<form method="POST" action="{{ route('login') }}">
								@csrf
								<div class="form-group">
									<input id="email" class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5 @error('email') is-invalid @enderror" type="email" placeholder="Email" autocomplete="off" name="email" value="{{ old('email') }}" />
								...
								<div class="form-group">
									<input id="password" class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5 @error('password') is-invalid @enderror" type="password" placeholder="Password" name="password" />
