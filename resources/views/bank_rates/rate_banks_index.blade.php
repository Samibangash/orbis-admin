@extends('layouts.app', ['page_title' => 'Rate Banks'])
...
@section('content')
    ...
    <div class="modal fade" id="addItemModel" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <!--begin::Form-->
                <form id="kt_modal_add" class="form" method="POST" enctype="multipart/form-data" action="{{ route('rate_bank.store') }}">
                    @csrf
    ...
    <div class="modal fade" id="editItemModel" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <!--begin::Form-->
                <form id="kt_modal_edit" class="form" method="POST" enctype="multipart/form-data" action="{{ route('rate_bank.update') }}">
                    @csrf
                    @method('PUT')
                    <div class="modal-header">
...
@push('scripts')
    <script>
        ...
        $("#kt_datatable").on('click', '.edit-item', function () {
            ...
            const method = 'POST';
            const url = "{{ route('rate_bank.edit') }}";
            ...
            $.ajax({ method, url, headers, data, dataType: 'json',
                success: function (data) {
                    ...
                    (data.image_path !== null)
                        ? $("#item_image_placeholder").css('background-image','url({{ URL::asset('/storage/images/ratebank')}}/'+data.image_path+')')
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function(data, type, full, meta) {
                                if(data !== null) {
                                    return '<img class="max-w-40px" src="{{ asset('/storage/images/ratebank') }}/'+ data +'">';
                                } else {
