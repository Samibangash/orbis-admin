@extends('layouts.app', ['page_title' => 'Bank Credit'])
@section('titles', 'Bank Credit')
...
@section('content')
    ...
    <div class="modal fade" id="addItemModel" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <!--begin::Form-->
                <form id="kt_modal_add" class="form" method="POST" action="{{ route('bank.credit.store') }}">
                    @csrf
    ...
    <div class="modal fade" id="editItemModel" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <!--begin::Form-->
                <form id="kt_modal_edit" class="form" method="POST"  action="{{ route('bank.credit.update') }}">
                    @csrf
                    @method('PUT')
                    <div class="modal-header">
...
@push('scripts')
    <script>
        ...
        $("#kt_datatable").on('click', '.edit-item', function () {
            ...
            const method = 'POST';
            const url = "{{ route('bank.credit.edit') }}";
        ...
        var KTDatatablesSearchOptionsAdvancedSearch = function() {
			...
			<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('bank.credit.ajax.list') }}",
